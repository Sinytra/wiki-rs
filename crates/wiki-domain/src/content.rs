...
impl ResourceLocation {
    ...
    pub const FORGE_NAMESPACE: &'static str = "forge";
    pub const FABRIC_NAMESPACE: &'static str = "fabric";
    ...
    pub const BUILTIN_NAMESPACES: &'static [&'static str] = &[
        ...
        ResourceLocation::FORGE_NAMESPACE,
        ResourceLocation::FABRIC_NAMESPACE,
    ];
